...
class User_RegisterController extends FinalView_Controller_Action
{
    ...
    public function registerAction()
    {
        if ($newUser = $this->_register()) {
            ...
            $this->_sendRegistrationConfirmationMail($newUser);
    ...
    public function confirmationAction()
    {
        ...
        $this->_sendRegistrationConfirmationMail($user);
    }
    ...
    */
    protected function _register()
    {
        ...
        if ($this->getRequest()->isPost()) {
            if ($this->_getForm()->isValid($this->getRequest()->getPost())) {

                $newUser = Doctrine::getTable('User')->create($this->_getForm()->getValues());
    ...
    protected function _sendRegistrationConfirmationMail($user)
    {

...
class User_Model_RememberMe
{
    ...
    {
        $this->_getCookies()->set($this->_identityKey, $user->{$this->_userIdentityKey}, $this->_expires);
        $this->_getCookies()->set($this->_credentialKey, $user->{$this->_userCredentialKey}, $this->_expires);
    }
    ...
    protected function _getCookies()
    {
        if ($this->_cookies === null) {
            $this->_cookies = FinalView_Cookies::getInstance();
        }
